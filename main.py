...
def solar_system():
    ...
    earth = Planet([center_w - 152.1, center_h], 6.371, [0, 29.3], 5.972*10**24, (0, 0, 255), "Earth")
    mars = Planet([center_w - 228, center_h], 3.390, [0, 21.972], 6.4185*10**23, (255, 0, 0), "Mars")
    ...
    vx = 9.3240737
    vy = 8.6473146
    p1 = Planet([center_w + x, center_h + y], 10, [vx/2, -vy/2], m, (0, 0, 255)) # blue
